...
var _Days = require('./components/Days.vue');

var _Days2 = _interopRequireDefault(_Days);

var _Slots = require('./components/Slots.vue');
...
var schedule = _socket2.default.channel('schedule', {});

schedule.join().receive('error', function () {
  return console.log('[schedule] error');
}).receive('ok', function () {
  return console.log('[schedule] ok');
});
...
var store = new _vuex2.default.Store({
  ...
  getters: {
    days: function days(state) {
      return state.days.map(function (_ref) {
        var date = _ref.date,
    ...
    slots: function slots(state) {
      return function (date) {
        ...
        try {
          for (var _iterator = state.days[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var day = _step.value;
...
var router = new _vueRouter2.default({
  ...
  routes: [{
    ...
    name: 'slots',
    props: true,
    component: _Slots2.default
  }, {
    path: '/',
    component: _Days2.default
  }]
});
...
require.register("js/components/BookSlot.vue", function(exports, require, module) {
;(function(){
'use strict';
...
exports.default = {
  ...
  computed: {
    availableSeats: function availableSeats() {
      return this.currentSlot.seats.filter(function (seat) {
    ...
    bookSlot: function bookSlot() {
      ...
      slot.seats = slot.seats.map(function (seat) {
        if (!!seat.name) {
          seat.is_booked = true;
          if (!seat.email) {
            seat.email = _this.email;
          }
        }
        return seat;
      });

      slot.is_booked = slot.seats.filter(function (seat) {
        return seat.is_booked;
      }).length === 3;
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.showForm)?_c('div',{staticClass:"time-booking-form"},[_c('div',[_c('span',{staticClass:"glyphicon glyphicon-time",attrs:{"aria-hidden":"true"}}),_vm._v(" "+_vm._s(_vm.humanTime(_vm.currentSlot))+"\n    ")]),_vm._v(" "),_c('hr'),_vm._v(" "),_c('h4',[_vm._v("Book this Time")]),_vm._v(" "),_c('p',[_vm._v("Your email is required to confirm your booking. It will not be shared or used for any other purpose.")]),_vm._v(" "),_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"sr-only",attrs:{"for":"email"}},[_vm._v("Email")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.email),expression:"email"}],ref:"email",staticClass:"form-control",attrs:{"type":"email","placeholder":"Enter your email","required":"","autofocus":""},domProps:{"value":(_vm.email)},on:{"input":function($event){if($event.target.composing){ return; }_vm.email=$event.target.value}}})]),_vm._v(" "),_c('p',[_vm._v("You may book up to "+_vm._s(_vm.availableSeats)+" seats for this slot. Please enter a name for each person attending.")]),_vm._v(" "),_vm._l((_vm.currentSlot.seats),function(seat){return (!seat.is_booked)?_c('div',{staticClass:"form-group"},[_c('label',{staticClass:"sr-only",attrs:{"for":"email"}},[_vm._v("Email")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(seat.name),expression:"seat.name"}],staticClass:"form-control",attrs:{"type":"text","placeholder":"Enter a name"},domProps:{"value":(seat.name)},on:{"input":function($event){if($event.target.composing){ return; }seat.name=$event.target.value}}})]):_vm._e()}),_vm._v(" "),_c('div',{staticClass:"form-group"},[_c('button',{staticClass:"btn btn-success",attrs:{"type":"button","disabled":!_vm.isValidBooking},on:{"click":_vm.bookSlot}},[_vm._v("Book")]),_vm._v(" "),_c('button',{staticClass:"btn btn-default",attrs:{"type":"button"},on:{"click":_vm.hideBookingForm}},[_vm._v("Cancel")])])],2):_c('div',{staticClass:"col-xs-9"},[_c('div',{staticClass:"pull-right"},[_c('button',{staticClass:"btn btn-info btn-sm",attrs:{"type":"button","name":"button"},on:{"click":_vm.showBookingForm}},[_c('span',{staticClass:"glyphicon glyphicon-question-sign",attrs:{"aria-hidden":"true"}}),_vm._v(" Request this time\n      ")])])])])}
...
;require.register("js/components/Days.vue", function(exports, require, module) {
;(function(){
'use strict';
...
exports.default = {
  ...
  methods: {
    humanDate: function humanDate(_ref) {
      var date = _ref.date;
      return (0, _moment2.default)(date).format('dddd Do');
    },
    route: function route(_ref2) {
      var date = _ref2.date;
      return { name: 'slots', params: { date: date } };
    }
  }
};
})()
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',[_vm._v("Showing from the 7th to 30th September")]),_vm._v(" "),_c('p',{staticClass:"lead"},[_vm._v("Choose a date to view available times and make a booking")]),_vm._v(" "),_c('table',{staticClass:"table table-hover"},[_c('tbody',_vm._l((_vm.days),function(day){return _c('tr',[_c('td',[_c('span',{staticClass:"glyphicon glyphicon-calendar",attrs:{"aria-hidden":"true"}}),_vm._v(" "+_vm._s(_vm.humanDate(day))+"\n        ")]),_vm._v(" "),_c('td',[(day.has_slots)?_c('router-link',{staticClass:"btn btn-success btn-sm",attrs:{"to":_vm.route(day)}},[_c('span',{staticClass:"glyphicon glyphicon-time",attrs:{"aria-hidden":"true"}}),_vm._v(" View Times\n          ")]):_c('span',{staticClass:"text-danger"},[_vm._v("This day is not available")])],1)])}))])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
;require.register("js/components/Schedule.vue", function(exports, require, module) {
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert(".table td {\n  width: 50%;\n}")
;(function(){
'use strict';
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-84db0c50", __vue__options__)
  } else {
    hotAPI.reload("data-v-84db0c50", __vue__options__)
  }
})()}
});

;require.register("js/components/Slots.vue", function(exports, require, module) {
;(function(){
'use strict';
...
var _BookSlot = require('./BookSlot.vue');

var _BookSlot2 = _interopRequireDefault(_BookSlot);
...
exports.default = {
  props: ['date'],
  components: {
    BookSlot: _BookSlot2.default
  },
  computed: {
    humanDate: function humanDate() {
      return (0, _moment2.default)(this.date).format('ddd Do MMMM');
    },
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',[_vm._v("Times for "+_vm._s(_vm.humanDate))]),_vm._v(" "),_c('p',{staticClass:"lead"},[_vm._v("Choose an available time to make a booking.")]),_vm._v(" "),_c('router-link',{staticClass:"btn btn-default",attrs:{"to":"/"}},[_c('span',{staticClass:"glyphicon glyphicon-calendar",attrs:{"aria-hidden":"true"}}),_vm._v(" View all days\n  ")]),_vm._v(" "),_c('table',{staticClass:"table table-hover"},[_c('tbody',_vm._l((_vm.slots),function(slot){return _c('tr',[_c('td',[_c('div',{staticClass:"row"},[_c('div',{staticClass:"col-xs-3"},[_c('span',{staticClass:"glyphicon glyphicon-time",attrs:{"aria-hidden":"true"}}),_vm._v(" "+_vm._s(_vm.humanTime(slot))+"\n            ")]),_vm._v(" "),(_vm.isAvailable(slot))?_c('book-slot',{attrs:{"currentSlot":slot}}):_c('div',{staticClass:"col-xs-9"},[_c('div',{staticClass:"pull-right  text-danger"},[_vm._v("\n                This time is not available\n              ")])])],1)])])}))])],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
